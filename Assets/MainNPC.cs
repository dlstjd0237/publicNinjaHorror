...
public class MinNPC : Interactable
{
    ...
    [SerializeField] private string _nextScnenName;
    [SerializeField] private TextSO SO;
    private enum State
    {
        Enter,
        Stay,
    ...
    private void InRoom()
    {
        ...
        {
            if (!firstArrivalCheck && QuestManager.Instance.QuestDataDic.Count <= 0)
            {
    ...
    public override void Interact()
    {
        if (isTalking == false)
        {
            ...
            {
                SceneControlManager.FadeOut(() => SceneControlManager.SetText(SO.TextInfoList, null, () => SceneManager.LoadScene(_nextScnenName)));
                isTalking = true;
